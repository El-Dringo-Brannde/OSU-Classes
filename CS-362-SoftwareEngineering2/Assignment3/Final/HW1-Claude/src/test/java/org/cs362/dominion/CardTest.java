...
public class CardTest {
	...
	public void testAdventurer(){
		...
		int curDiscardSize = playerA.discard.size();
		playerA.playKingdomCard();
		assertTrue(playerA.hand.size() == 7);
		assertTrue(playerA.discard.size() <= curDiscardSize);
	...
	public void testSalvager(){
		...
		assertTrue(playerA.numBuys == 1); //get an extra buy
		assertTrue(playerA.hand.size() >= 5);
	...
	public void testVillage(){
		...
		assertTrue(playerA.hand.size() == 6);
	...
	public void testAmbassador(){
		...
		assertTrue(playerA.hand.size() < 5); //BUG
	...
	public void testBaron(){
		...
		assertTrue(playerA.hand.size() < 8);
	}
	@Test
	...
	public void testFeast(){
		...
		assertTrue(playerA.hand.size() >= 4);
	...
	public void testGreathall(){
		...
		playerA.coins = 0;
		playerA.numBuys = 1;
		int beforeCard = playerA.hand.size();
		...
		assertTrue(playerA.hand.size()+1 == beforeCard);
